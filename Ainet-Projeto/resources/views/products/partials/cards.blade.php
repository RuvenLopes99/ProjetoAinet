...
<div class="flex flex-col rounded-lg border border-zinc-200 bg-white shadow-md transition-shadow duration-300 hover:shadow-xl dark:border-zinc-700 dark:bg-zinc-800">
    ...
    <div class="flex flex-1 flex-col p-4">
        <a href="{{ route('products.show', $product) }}">
            <h2 class="text-lg font-semibold text-zinc-800 hover:text-blue-600 dark:text-white dark:hover:text-blue-400">{{ $product->name }}</h2>
        </a>

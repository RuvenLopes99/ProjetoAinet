            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @auth
                        ...
                        <x-nav-link :href="route('products.showcase')" :active="request()->routeIs('products.showcase')">
                            {{ __('Catálogo') }}
                        </x-nav-link>
                        ...
                        @if(Auth::user()->type == 'member' || Auth::user()->type == 'board')
                            ...
                            <x-nav-link :href="route('member.card.show')" :active="request()->routeIs('member.card.show')">
                                {{ __('Meu Cartão') }}
                            </x-nav-link>
                        @endif
                            ...
                            <div class="hidden sm:flex sm:items-center sm:ms-6">
                                <x-dropdown align="left" width="48">
                                    ...
                                    <x-slot name="content">
                                        ...
                                        <x-dropdown-link :href="route('admin.inventory.index')">
                                            {{ __('Inventário') }}
                                        </x-dropdown-link>
                ...
                @auth
                    ...
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link :href="route('member.statistics.index')">
                                {{ __('Minhas Estatísticas') }}
                            </x-dropdown-link>
